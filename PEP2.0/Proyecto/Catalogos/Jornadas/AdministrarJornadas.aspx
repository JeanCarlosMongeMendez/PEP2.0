<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="AdministrarJornadas.aspx.cs" Inherits="Proyecto.Catalogos.Jornadas.AdministrarJornadas" MaintainScrollPositionOnPostback="true"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <asp:Repeater ID="rpJornadas" runat="server">
                            ...
                            <ItemTemplate>
                                <tr style="text-align: center">
                                    <td>
                                        <asp:LinkButton ID="btnEditar" runat="server" ToolTip="Editar" CommandArgument='<%# Eval("idJornada") %>' OnClick="btnEditar_Click"><span class="btn glyphicon glyphicon-pencil"></span></asp:LinkButton>
                                        <asp:LinkButton ID="btnEliminar" runat="server" ToolTip="Eliminar" CommandArgument='<%# Eval("idJornada") %>' OnClick="btnEliminar_Click"><span class="btn glyphicon glyphicon-trash"></span></asp:LinkButton>
                                    </td>
                                    <td>
                                        <%# Eval("descJornada") %>
                                    </td>
                                    <td>
                                        <%# Eval("porcentajeJornada") %> %
                                    </td>
                                </tr>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div id="modalEditarJornada" class="modal fade" role="alertdialog">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer" style="text-align: center">
                            <asp:Button ID="btnEditarJornadaModal" runat="server" Text="Editar" CssClass="btn btn-primary" OnClick="btnEditarJornadaModal_Click"/>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                        </div>
                    </div>
    ...
    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
        <ContentTemplate>
            <div id="modalEliminarJornada" class="modal fade" role="alertdialog">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Eliminar jornada</h4>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer" style="text-align: center">
                            <asp:Button ID="btnEliminarJornadaModal" runat="server" Text="Eliminar" CssClass="btn btn-primary" OnClick="btnEliminarJornadaModal_Click"/>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function activarModalEditarJornada() {
            $('#modalEditarJornada').modal('show');
        };

        function activarModalEliminarJornada() {
            $('#modalEliminarJornada').modal('show');
        };
    </script>
