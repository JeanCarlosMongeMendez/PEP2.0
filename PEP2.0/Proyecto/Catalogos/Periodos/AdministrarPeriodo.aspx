...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                                ...
                                <tr style="text-align: center">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <asp:LinkButton ID="btnSelccionar" runat="server" ToolTip="Seleccionar" OnClick="btnSelccionar_Click" CommandArgument='<%# Eval("anoPeriodo") %>' CssClass="btn glyphicon glyphicon-ok"></asp:LinkButton>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <%--<asp:CheckBox ID="cbProyecto" runat="server" Text="" />--%>
                                            <asp:LinkButton ID="btnHabilitarActual" runat="server" ToolTip="Seleccionar" OnClick="EstablecerPeriodoActual_Click" CommandArgument='<%# Eval("anoPeriodo") %>' CssClass="btn glyphicon glyphicon-thumbs-up"></asp:LinkButton>
                                        </div>
                                    </td>
                                    <td>
                            ...
                            <asp:Repeater ID="rpProyectos" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr style="text-align: center">
                                        <td>
                                            <div class="btn-group">
                                                <asp:LinkButton ID="btnSelccionarProyecto" runat="server" ToolTip="Seleccionar proyecto" OnClick="btnSelccionarProyecto_Click" CommandArgument='<%# Eval("idProyecto") %>' CssClass="btn glyphicon glyphicon-ok"></asp:LinkButton>
                                            </div>
                                        </td>
                                        <td>
                                            <%# Eval("nombreProyecto") %>
                                        ...
                                        <td>
                                            <asp:LinkButton ID="btnEditarProyecto" runat="server" ToolTip="Editar proyecto" CommandArgument='<%# Eval("idProyecto") %>' OnClick="btnEditarProyecto_Click" CssClass="btn glyphicon glyphicon-pencil"></asp:LinkButton>
                                            <asp:LinkButton ID="btnEliminarProyecto" runat="server" ToolTip="Eliminar" CommandArgument='<%# Eval("idProyecto") %>' OnClick="btnEliminarProyecto_Click" CssClass="btn glyphicon glyphicon-trash"></asp:LinkButton>
                                        </td>
                            ...
                            <asp:Repeater ID="rpUnidProyecto" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr style="text-align: center">
                                        ...
                                        <td>
                                            <asp:LinkButton ID="btnEditarUnidades" runat="server" ToolTip="Editar" CommandArgument='<%# Eval("idUnidad") %>' OnClick="btnEditarUnidad_Click" CssClass="btn glyphicon glyphicon-pencil"></asp:LinkButton>
                                            <asp:LinkButton ID="btnEliminarUnidad" runat="server" ToolTip="Eliminar" CommandArgument='<%# Eval("idUnidad") %>' OnClick="btnEliminarUnidad_Click" CssClass="btn glyphicon glyphicon-trash"></asp:LinkButton>
                                            <asp:LinkButton ID="btnSubUnidades" runat="server" ToolTip="Sub unidades" CommandArgument='<%# Eval("idUnidad") %>' OnClick="btnSubUnidades_Click" CssClass="btn glyphicon glyphicon-th-list"></asp:LinkButton>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
    ...
    <div id="modalEliminarProyecto" class="modal fade" role="alertdialog">
                                            ...
                                            <table id="tbProyectosPasar" class="table table-bordered">
                                                ...
                                                <asp:Repeater ID="rpTransferirProyecto" runat="server">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr style="text-align: center">
                                                            <td>
                                                                <asp:LinkButton ID="btnSeleccionarProyectoT" runat="server" ToolTip="Transferir proyecto" CommandArgument='<%# Eval("idProyecto") %>' OnClick="btnSeleccionarProyectoT_Click" CssClass="btn glyphicon glyphicon-share-alt"></asp:LinkButton>
                                                            </td>
                                                            <td>
                                                                <%# Eval("nombreProyecto") %>
                                                            </td>
        ...
        <div id="modalConfirmarPeriodo" class="modal fade" role="alertdialog">
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <asp:UpdatePanel ID="UPconfirmarProyecto" runat="server">
                        <ContentTemplate>
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title">Confirmar Eliminar Proyecto</h4>
                            </div>
                            <div class="modal-body">
                                <%-- campos a llenar --%>
                                <div class="row">
        ...
        <div id="modalSubUnidades" class="modal fade" role="alertdialog">
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title">Sub Unidades</h4>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-xs-12 col-sm-12">
                                        ...
                                        <div class="col-md-6 col-xs-6 col-sm-6">
                                            <asp:TextBox class="form-control" ID="txtNombreSubUnidad" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-xs-12 col-sm-12">
                                        <asp:Button ID="btnNuevaSubUnidad" runat="server" Text="Agregar sub unidad" CssClass="btn btn-primary" OnClick="btnNuevaSubUnidad_Click" />
                                    </div>
                                    <div class="col-md-12 col-xs-12 col-sm-12" style="text-align: right">
                                        <hr />
                                    </div>
                                    <!-- ------------------------ Tabla unidades proyecto --------------------------- -->
                                    <div class=" table-responsive col-md-12 col-xs-12 col-sm-12 col-lg-12" style="text-align: center; overflow-y: auto;">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <asp:Repeater ID="rpSubUnidades" runat="server">
                                                <HeaderTemplate>
                                                </HeaderTemplate>
                    ...
                    <table class="table" style="max-width:664px;">
                        <tr style="padding:1px !important">
                            ...
                            <td style="padding:1px !important">
                                <asp:DataList ID="rptPaginacion6" runat="server"
