<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="EditarProyecto.aspx.cs" Inherits="Proyecto.Catalogos.Proyecto.EditarProyecto" %>
    ...
    <div class="divRedondo">
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <center>
                        <asp:Label ID="lblEditarProyecto" runat="server" Text="Editar Proyecto" Font-Size="Large" ForeColor="Black"></asp:Label>
                    </center>
            </div>
            <%-- fin titulo accion --%>
            ...
            <div class="col-md-12 col-xs-12 col-sm-12 mt-1">
                <div class="col-md-2 col-xs-2 col-sm-2">
                    <asp:Label ID="lblCodigoProyecto" runat="server" Text="Código del proyecto <span style='color:red'>*</span> " Font-Size="Medium" ForeColor="Black" CssClass="label"></asp:Label>
                </div>
                <div class="col-md-4 col-xs-4 col-sm-4">
