...
{
    public partial class NuevaCajaChica : System.Web.UI.Page
    {
        ...
        protected void rptPaginacion5_ItemDataBound(object sender, DataListItemEventArgs e)
        {
            ...
            lnkPagina.Enabled = false;
            lnkPagina.BackColor = Color.FromName("#005da4");
            lnkPagina.ForeColor = System.Drawing.Color.FromName("#FFFFFF");
        }
        #endregion
        #region page load
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                numeroCajaChica = cajaChicaServicios.getNumeroSolicitudCajaChica(periodo.anoPeriodo);
                Label5.Text = numeroCajaChica +" - "+ periodo.anoPeriodo;
