<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="EliminarCajaChica.aspx.cs" Inherits="Proyecto.Catalogos.CajaChica.EliminarCajaChica" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="col-md-12 col-xs-12 col-sm-12" style="text-align: center">
                    <asp:Label ID="label" runat="server" Text="Eliminar Caja Chica" Font-Size="Large" ForeColor="Black"></asp:Label>
                </div>
                <%-- fin titulo pantalla --%>
                ...
                <div class="form-group col-md-12 col-xs-12 col-sm-12 col-lg-12" id="div1" runat="server">
                    ...
                    <asp:TextBox ID="txtcomentario" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                </div>
