...
{
    public partial class VerCajaChica : System.Web.UI.Page
    {
        #region page load
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Entidades.CajaChica cajaChica = (Entidades.CajaChica)Session["ejecucionVer"];
                ...
                txtDescripcion.Text = cajaChica.comentario;
