...
<%--                <div class="col-md-12 col-xs-12 col-sm-12" style="text-align: left">
            ...
            <%--    <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
                        ...
                        <div class="col-md-4 col-xs-4 col-sm-4">
                            <asp:FileUpload ID="fuArchivos" runat="server" AllowMultiple="true" CssClass="form-control" ViewStateMode="Enabled" />
                            <br />
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <asp:Button ID="btnSeleccionarArchivo" runat="server" Text="Cargar Archivo(s)" OnClick="btnSeleccionarArchivo_Click" />
                                    <asp:Button ID="btnQuitarArchivo" runat="server" Text="Quitar Archivo(s)" OnClick="btnQuitarArchivo_Click" Visible="false" />
                                </ContentTemplate>
                                <Triggers>
                                    <asp:PostBackTrigger ControlID="btnSeleccionarArchivo" />
                                    <asp:PostBackTrigger ControlID="btnQuitarArchivo" />
                                </Triggers>
                            </asp:UpdatePanel>
                            <br />
