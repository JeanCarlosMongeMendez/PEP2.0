...
{
    public partial class EditarEjecucion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Entidades.Ejecucion ejecucion = (Entidades.Ejecucion)Session["ejecucionEditar"];
        ...
        /// Leonardo Carrion
        /// 10/mar/2021
        /// Efecto: se encarga de guardar los archivos seleccionados en el servidor
        /// Requiere: clic en el boton de Guardar
        /// Modifica: -
        /// Devuelve: Muestra mensaje en pantalla los archivos repetidos
        /// </summary>
        /// <param name="ejecucion"></param>
        /// <param name="fuArchivos"></param>
        /// <returns></returns>
        public List<ArchivoEjecucion> guardarArchivos(Entidades.Ejecucion ejecucion, FileUpload fuArchivos)
        {
            ...
            foreach (HttpPostedFile file in fuArchivos.PostedFiles)
            {
                ...
                String carpeta = ejecucion.idEjecucion + "";
                ...
                if (guardado == 0)
                {
                    ...
                    archivoEjecucion.creadoPor = (String)Session["nombreCompleto"];
        ...
        /// Leonardo Carrion
        /// 02/mar/2021
        /// Efecto: muestra o no el campo de texto para ingresar el dato de otro
        /// Requiere: cambiar dato de DropDownList de tipo de tramite
        /// Modifica: visibillidad de campo de texto de otro
        /// Devuelve: -
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        {
            if (ddlTipoTramite.SelectedItem.Text == "Otros")
            {
                divTipoTramiteOtro.Visible = true;
            }
            else
            {
                divTipoTramiteOtro.Visible = false;
            }
        }
            ...
            else
            {
                ...
                foreach (Partida partida in listaPartidasAsociadas)
                {
                    ...
                    if (listaPartidaUnidadAsociadasTemp.Count() == 0)
                    {
                        ...
                        partidaUnidad.montoDisponible = ejecucionUnidadParitdaServicios.getMontoDisponible(unidad, partida);
        ...
        /// Leonardo Carrion
        /// 18/mar/2021
        /// Efecto: elimina el archivo seleccionado
        ...
        protected void btnEliminarArchivo_Click(object sender, EventArgs e)
        {
            ...
            ArchivoEjecucion archivoEjecucion = new ArchivoEjecucion();
            archivoEjecucion.idArchivoEjecucion = idArchivo;
            archivoEjecucion.nombreArchivo = nombreArchivoEliminar;
            archivoEjecucion.rutaArchivo = ruta;
            ...
            Entidades.Ejecucion ejecucion = (Entidades.Ejecucion)Session["ejecucionEditar"];
            List<ArchivoEjecucion> listaArchivosEjecucion = archivoEjecucionServicios.obtenerArchivoEjecucion(ejecucion.idEjecucion);

            //Session["listaArchivosMuestraAsociados"] = listaArchivosMuestra.Count > 0 ? listaArchivosMuestra : null;
            Session["listaArchivosAsociados"] = listaArchivosEjecucion;
        ...
        /// Leonardo Carrion
        /// 19/mar/2021
        /// Efecto: agrega archivos a la ejecucion
        ...
        protected void btnAgregarArchivos_Click(object sender, EventArgs e)
        {
            ...
            if (fuArchivos != null && fuArchivos.HasFiles)
            {
                ...
                List<ArchivoEjecucion> listaArchivosEjecuciones = archivoEjecucionServicios.obtenerArchivoEjecucion(ejecucion.idEjecucion);

                Session["listaArchivosAsociados"] = listaArchivosEjecuciones;

                cargarArchivos();
            }
            else
            {
                //(this.Master as SiteMaster).Mensaje("Si desea agregar un(os) archivos a esta muestra, primero debe \"Elegir archivos\" y luego darle clic al botón \"Agregar archivos\".", "¡Alerta!");
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "toastr.error('" + "Si desea agregar un(os) archivos a esta ejecución, primero debe \"Elegir archivos\" y luego darle clic al botón \"Agregar archivos\"." + "');", true);
            }
        }
        ...
        {
            if (!String.IsNullOrEmpty(txtNumeroReferencia.Text))
            {
                List<PartidaUnidad> listaPartidaUnidadAsociadas = (List<PartidaUnidad>)Session["listaPartidaUnidadAsociadas"];
                ...
                if (listaPartidaUnidadAsociadas.Count > 0)
                {
                    ...
                    estadoEjecucion = estadoEjecucionServicios.getEstadoEjecucionSegunNombre("Guardado");
                    ...
                    int.TryParse(ddlTipoTramite.SelectedValue, out int idTramite);
                    TipoTramite tipoTramite = new TipoTramite();
                    tipoTramite.idTramite = idTramite;

                    ejecucion.estadoEjecucion = estadoEjecucion;
                    ejecucion.anoPeriodo = periodo.anoPeriodo;
                    ejecucion.idProyecto = proyecto.idProyecto;
                    ejecucion.monto = monto;
                    ejecucion.tipoTramite = tipoTramite;
                    ejecucion.numeroReferencia = txtNumeroReferencia.Text;

                    if (ddlTipoTramite.SelectedItem.Text == "Otros")
                    {
                        ejecucion.descripcionEjecucionOtro = txtTipoTramiteOtro.Text;
                    }
                    else
                    {
                        ejecucion.descripcionEjecucionOtro = "";
                    }
                    ...
                    {
                        ejecucionUnidadParitdaServicios.insertarEjecucionUnidadPartida(ejecucion.idEjecucion, partidaUnidad.idUnidad, partidaUnidad.idPartida, partidaUnidad.monto);
                    }
