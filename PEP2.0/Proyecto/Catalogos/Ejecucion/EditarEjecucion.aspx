<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="EditarEjecucion.aspx.cs" Inherits="Proyecto.Catalogos.Ejecucion.EditarEjecucion" MaintainScrollPositionOnPostback="true" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="col-md-12 col-xs-12 col-sm-12" style="text-align: center">
                    <asp:Label ID="label" runat="server" Text="Editar Ejecución" Font-Size="Large" ForeColor="Black"></asp:Label>
                </div>
                <%-- fin titulo pantalla --%>
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <asp:UpdatePanel runat="server">
                                            <ContentTemplate>
                                                <asp:LinkButton ID="btnEliminarArchivo" runat="server" CssClass="btn btn-default" Text="Eliminar" OnClick="btnEliminarArchivo_Click" CommandArgument='<%#Eval("idArchivoEjecucion") + ";" + Eval("nombreArchivo") + ";" + Eval("rutaArchivo") %>'></asp:LinkButton>
                                            </ContentTemplate>
                                            <Triggers>
                                                <asp:PostBackTrigger ControlID="btnEliminarArchivo" />
                                            </Triggers>
                                        </asp:UpdatePanel>
                                    </td>
                                </tr>
                        ...
                        <table id="Table1" runat="server" class="table table-striped ">
                            ...
                            <tr>
                                <td>
                                    <asp:UpdatePanel runat="server">
                                        ...
                                        <Triggers>
                                            <asp:PostBackTrigger ControlID="btnAgregarArchivos" />
                                        </Triggers>
                                    </asp:UpdatePanel>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="alert-danger">
                                    <asp:Label ID="Label11" runat="server" Text="Se debe dar clic al boton de 'Agregar archivos' para adjuntar los archivos a la muestra"></asp:Label>
                                </td>
                            </tr>
                        </table>
