...
{
    public partial class NuevaEjecucion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Session["listaUnidadesAsociadas"] = new List<Unidad>();
            ...
            {
                if (Session["archivos"] != null && !fuArchivos.HasFiles)
                {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(txtNumeroReferencia.Text))
            {
                ...
                if (listaPartidaUnidadAsociadas.Count > 0)
                {
                    ...
                    ejecucion.realizadoPor = (String)Session["nombreCompleto"];
                    ejecucion.fecha = DateTime.Now;

                    ejecucion.idEjecucion = ejecucionServicios.InsertarEjecucion(ejecucion);
        ...
        /// Leonardo Carrion
        /// 09/mar/2021
        /// Efecto: pone el estado de comprometer en la ejecucion y guarda los datos seleccionados en la base de datos
        /// Requiere: dar clic al boton de comprometer
        /// Modifica: -
        /// Devuelve: -
        /// </summary>
        /// <param name="sender"></param>
        ...
        protected void btnComprometer_Click(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(txtNumeroReferencia.Text))
            {
                ...
                if (listaPartidaUnidadAsociadas.Count > 0)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "toastr.success('" + "Se comprometio con exito" + "');", true);
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "toastr.error('" + "Debe de repartir los gastos entre la unidad(es)" + "');", true);
        ...
        /// Leonardo Carrion
        /// 11/mar/2021
        /// Efecto: selecciona y pone en la variable session los archivos seleccionados en fileupload
        /// Requiere: dar clic en el boton de "cargas archivos"
        /// Modifica: variable session de archivos
        /// Devuelve: -
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        {
            Session["archivos"] = fuArchivos;
            IList<HttpPostedFile> archivos = fuArchivos.PostedFiles;

            if (fuArchivos.HasFiles)
            {
                btnQuitarArchivo.Visible = true;
                lblArchivosVacio.Text = "";

                foreach (HttpPostedFile arch in archivos)
                {
                    lblArchivosVacio.Text += arch.FileName + ". ";
                }
            }
        }
        ...
        /// Leonardo Carrion
        /// 11/mar/2019
        /// Efecto: Quitar archivos seleccionados
        /// Requiere: dar clic en el boton de "Quitar archivos"
        /// Modifica:  variable session de archivos
        /// Devuelve: -
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void btnQuitarArchivo_Click(object sender, EventArgs e)
        {
            Session["archivos"] = null;
            fuArchivos = null;
