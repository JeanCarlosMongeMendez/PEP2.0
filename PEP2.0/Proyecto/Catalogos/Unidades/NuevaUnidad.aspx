<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="NuevaUnidad.aspx.cs" Inherits="Proyecto.Catalogos.Unidades.NuevaUnidad" %>
    ...
    <div class="divRedondo">
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <center>
                        <asp:Label ID="lblNuevaUnidad" runat="server" Text="Nueva Unidad" Font-Size="Large" ForeColor="Black"></asp:Label>
                    </center>
            </div>.
            <%-- fin titulo accion --%>
