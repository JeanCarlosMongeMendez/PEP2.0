...
{
    public partial class ReporteEjecuciones : System.Web.UI.Page
    {
        #region variables globales
        PeriodoServicios periodoServicios = new PeriodoServicios();
        ProyectoServicios proyectoServicios = new ProyectoServicios();
        Reporte_EjecucuionesServicios reporte_jecucionesServicios = new Reporte_EjecucuionesServicios();
        #endregion
        #region page load
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Session["listaReporteEgresos"] = reporte_jecucionesServicios.getReporteEjecuciones(periodo, proyecto);
        ...
        public void cargarDatosReporte()
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("ReporteEjecuciones.rdlc");
            ReportDataSource reportDataSource = null;
            List<Reporte_Ejecuciones> listaReporteDuracion = (List<Reporte_Ejecuciones>)Session["listaReporteEgresos"];
